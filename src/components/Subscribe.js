    ...
    return (
      <React.Fragment>
        ...
        <section className="seo_fact_area sec_pad">
          ...
          <div className="container">
            <SeoTitle Title="Over 4000+ students in 2022 & still counting." />
            <div className="seo_fact_info">
              <div className="seo_fact_item">
                <div className="text">
                  <div className="counter one">4086+</div>
                  <p>Enrolled Students</p>
                </div>
              </div>
              <div className="seo_fact_item">
                <div className="text">
                  <div className="counter two">227</div>
                  <p>Tutors</p>
                </div>
              </div>
              <div className="seo_fact_item">
                <div className="text">
                  <div className="counter three">53</div>
                  <p>Centers in BW</p>
                </div>
              </div>
              <div className="seo_fact_item last">
                <div className="text">
                  <div className="counter four">1</div>
                  <p>Center in SA</p>
                </div>
              </div>
            </div>
            ...
            <div className="seo_sec_title text-center mb_70">
              <Fade bottom>
                <h2>
                  ...
                  <br /> and beloved by executives, everywhere.
                </h2>
              </Fade>
            </div>
